...
#include "RobotTVDistortionUI.hpp"


START_NAMESPACE_DISTRHO

namespace Art = RobotTVDistortionArtwork;
      ...
      
{
    ...
    Image scaleImage(RobotTVDistortionArtwork::scaleData, RobotTVDistortionArtwork::scaleWidth, RobotTVDistortionArtwork::scaleHeight);
    Image interpolationImage(RobotTVDistortionArtwork::interpolationData, RobotTVDistortionArtwork::interpolationWidth, RobotTVDistortionArtwork::interpolationHeight);
    Image amp_typeImage(RobotTVDistortionArtwork::amp_typeData, RobotTVDistortionArtwork::amp_typeWidth, RobotTVDistortionArtwork::amp_typeHeight);
